...
// Глобальная функция-хелпер для удобного доступа
...
if (!function_exists('kbps_debug')) {
    function kbps_debug($message, $context = []) {
        return KBPSLogger::get_instance()->debug($message, $context);
    }
}